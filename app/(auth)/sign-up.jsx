    ...
    <SafeAreaView className='bg-primary h-full'>
        <ScrollView>
            <View className='w-full justify-center min-h-[80vh] px-4 my-6'>
                ...
                <Text className='text-2xl text-white text-semibold mt-10 font-psemibold'>Sign Up to ShopLook</Text>
                ...
                />
                <FormField title='E-mail' value={form.email} handleChangeText={(e)=>setForm({
                    ...form,email:e
                })}
                otherStyles='mt-7'
